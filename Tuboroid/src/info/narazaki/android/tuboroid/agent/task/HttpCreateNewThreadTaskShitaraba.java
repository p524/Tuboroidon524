...
public class HttpCreateNewThreadTaskShitaraba extends TextHttpPostTaskBase {
    ...
    public HttpCreateNewThreadTaskShitaraba(final BoardData board_data, final NewThreadData new_thread_data, Callback callback) {
    ...
    protected boolean setRequestParameters(HttpRequestBase req) {
        try {
            ...
            String[] tags = board_data_.server_def_.board_tag_.split("/");
